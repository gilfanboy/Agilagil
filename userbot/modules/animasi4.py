...
async def koc(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        ...
        await e.edit("`SEPEEERTIIIII AGIL GANTENG BERJEMBUT`")
        await e.edit("`JEMBUUUT WARNAAA WARNII`")
        await e.edit("`BAGAI GULALI`")
        await e.edit("`IMUUUTTTTT LUCUUU`")
        await e.edit("`BAGAIKAN BABI`")
        await e.edit("`GW GABUUTTTT`")
        await e.edit("`EMMMM BACOTNYA`")
        await e.edit("`WOI AGIL DIKEJAR TIREX`")
        await e.edit("🙈🙈🙈🙈")
        await e.edit("🙉🙉🙉🙉")
        await e.edit("🙈🙈🙈🙈")
        await e.edit("🙉🙉🙉🙉")
        await e.edit("`TOLONGIN AGIL`")
        await e.edit("🙉🙉🙉🙉")
        await e.edit("🐢                       🚶")
        await e.edit("🐢                      🚶")
        await e.edit("🐢                     🚶")
        ...
        await e.edit("🚶                               🐢")
        await e.edit("🚶                                🐢")
        await e.edit("`NGAPAIN DILIAT? UDAH TAU AGIL GANTENG!`")
